 ...
 */
public class SwipeCloseLayout extends ViewGroup {
     ...
     */
    private boolean enablePullToClose = true;
    ...
    private boolean enableFlingClose = true;
     ...
     * @param b
     */
    public void setEnableFlingClose(boolean b) {
        enableFlingClose = b;
    }
    ...
    @Deprecated
    public void setOnPullToCloseListener(SwipeCloseListener listener) {
        swipeCloseListener = listener;
    }

    public void setOnSwipeCloseListener(SwipeCloseListener listener) {
        swipeCloseListener = listener;
    }
    ...
    public SwipeCloseLayout(Context context, AttributeSet attrs) {
        ...
        viewDragHelper = ViewDragHelper.create(this, 1.0f, new ViewDragHelperCallClose());
    }
    ...
    public void setEnablePullToClose(boolean b) {
        enablePullToClose = b;
    }
    ...
    private void ensureTarget() {
        if (target == null) {
            if (getChildCount() > 1) {
                throw new IllegalStateException("SwipeCloseLayout must contains only one direct child");
            }
            target = getChildAt(0);
    ...
    private class ViewDragHelperCallClose extends ViewDragHelper.Callback {

        @Override
        public boolean tryCaptureView(View child, int pointerId) {
            return child == target && enablePullToClose;
        }
        ...
        public void onViewPositionChanged(View changedView, int left, int top, int dx, int dy) {
            ...
            if (swipeCloseListener != null) {
                swipeCloseListener.onViewPositionChanged(fractionAnchor, fractionScreen);
            }
        }
        ...
        public void onViewReleased(View releasedChild, float xvel, float yvel) {
            ...
            if (enableFlingClose && backBySpeed(xvel, yvel)) {
                isClosed = !canChildScrollUp();
            ...
            switch (dragEdge) {
                case LEFT:
                    finalLeft = isClosed ? horizontalDragRange : 0;
                ...
                case RIGHT:
                    ...
                    break;
                case TOP:
                    finalTop = isClosed ? verticalDragRange : 0;
    ...
    private void smoothScrollToX(int finalLeft) {
        if (viewDragHelper.settleCapturedViewAt(finalLeft, 0)) {
            ViewCompat.postInvalidateOnAnimation(SwipeCloseLayout.this);
        }
    }
